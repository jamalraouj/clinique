 ...
 */
final class Version20220718153239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medecin (id INT AUTO_INCREMENT NOT NULL, matricule VARCHAR(40) NOT NULL, experience LONGTEXT DEFAULT NULL, salaire DOUBLE PRECISION NOT NULL, temps_travail TIME NOT NULL, jour_travail DATE NOT NULL, status_medecin VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, genre_repas VARCHAR(255) NOT NULL, nom_repas VARCHAR(255) NOT NULL, aperitifs VARCHAR(255) NOT NULL, desert VARCHAR(255) NOT NULL, categorie VARCHAR(255) NOT NULL, jour TIME NOT NULL, temps TIME NOT NULL, repas_alternative VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
